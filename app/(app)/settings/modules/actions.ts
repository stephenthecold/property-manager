  ...
  await saveModules(
    {
      ...
      publicSite: fd.get("publicSite") === "on",
      mailbox: fd.get("mailbox") === "on",
      tenantLedgerExport: fd.get("tenantLedgerExport") === "on",
      portfolio: fd.get("portfolio") === "on",
      payments: fd.get("payments") === "on",
    },
    await auditActor(),
  );
